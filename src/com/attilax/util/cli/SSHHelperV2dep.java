...
*/
@Deprecated
public class SSHHelperV2dep{
     private final static Log logger =LogFactory.getLog(SSHHelperV2dep.class);

     private String     charset = Charset.defaultCharset().toString();
     private Session session;

     public SSHHelperV2dep(String host, Integer port, String user, String password) throws JSchException {
