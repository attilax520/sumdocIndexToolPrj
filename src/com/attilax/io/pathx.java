...
//			}
			...
			public static String toOsPath(String zipFilePath) {
			  if(isWindows())
			  {
				  zipFilePath=fixSlash2reversSplash(zipFilePath);
				  if(! zipFilePath.trim().toLowerCase().contains(":") )
				return "c:"+zipFilePath;
				  else
					  return zipFilePath;
			  }
			return zipFilePath;
			...
			public static String filemainname(String name) {
				int dotindex=name.lastIndexOf(".");
				return name.substring(0,dotindex);
			}

			public static String shellex() {
				  if(isWindows())
					  return "bat";
				  else
					  return "sh";
