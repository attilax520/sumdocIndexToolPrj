...
public class FileTraveList {
	...
	public static void main(String[] args) throws IOException {
		...
		String dir="D:\\000000\\Axure8.0\\Axure8.0";
		// 处理下级多层目录
				Files.walkFileTree(Paths.get(dir), new SimpleFileVisitor<Path>() {
					...
					public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
						...
						//get rlt path
						String fpath2=	fpath.substring(prefix.length()-0, fpath.length());
						System.out.println("\t正在访问 relt :" + fpath2 + "文件");
						FileUtils.writeStringToFile(new File("d:\\dirindex.txt"), fpath2 + "\r\n", true);
